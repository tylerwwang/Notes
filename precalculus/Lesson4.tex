...
\edef\mysubtitle{Lesson 4: Inequalities}
\edef\mydate{July 7, 2024}
...
\label{def:inc}
\end{define}
\footnotetext{Technically, this is defined for any ordered set with a notion of "biggness", but for this introductory course, we will restrict ourselves just to $\real$, or subsets of $\real$.}
\begin{define}
...
\begin{ex}
	...
	\begin{figure*}
		\centering
		\resizebox{0.6\textwidth}{!}{\includegraphics{assets/Lesson4/quadplots.png}}
		\caption{}
		\label{fig:quad}
	\end{figure*}
...
\begin{figure*}[h]
	\centering
	\resizebox{0.6\textwidth}{!}{\includegraphics{assets/Lesson4/upperbound.png}}
	\caption{}
	\label{fig:upper}
\end{figure*}
...
\begin{figure*}[h]
	\centering
	\resizebox{0.6\textwidth}{!}{\includegraphics{assets/Lesson4/lowerbound.png}}
	\caption{}
	\label{fig:lower}
\end{figure*}
...
\begin{figure*}[h]
	\centering
	\resizebox{0.6\textwidth}{!}{\includegraphics{assets/Lesson4/limitplot.png}}
	\caption{}
	\label{fig:limit}
\end{figure*}
...
\begin{figure*}[h]
	\centering
	\resizebox{0.6\linewidth}{!}{\includegraphics{assets/Lesson4/nolimit.png}}
	\caption{}
	\label{fig:nolimit}
\end{figure*}
...
If $L$ is the limit of $f$ at a point $c$, we somtimes denote this by the notation
$$\lim_{x \to c} f(x) = L.$$
...
\begin{ex}
	...
	The solutions of this equation represent points where the function is just outside of the desired bound.
...
\begin{proof}
	...
	By the limit defintion, we have
...
\begin{proof}
	...
	$$|g(x)-L|<\delta$$
	since $\delta>0$.
	Since $g(x)\in \mathcal D$ is within $\delta$ of $L$, we conclude by ineuqality \eqref{eq:comp-func-lim-ineq1} that
	$$|f(g(x))-f(L)|<\epsilon$$
...
\begin{proof}
	...
	By continunity, there exists $\delta_0,\delta_1>0$ such that
	\begin{align*}
