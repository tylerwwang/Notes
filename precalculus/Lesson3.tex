...
$$a(x+p)(x+q).$$
We should expect exactly two factors since, if there are any less than when expanding, we would not get the $x^2$ term, and if there are any more, then we would get a term of order higher than 2.\footnote{Check this!}
...
\footnotetext{Ironicly, because this theorem requires complex analysis to prove (which is like complex calculus), this theorem is neither fundamental nor a theorem about algebra.}
