...
\begin{remark}
	...
	This shows that the exponential of imaginary numbers must result in \textit{rotations} around the origin.
	...
	\resizebox{0.4\textwidth}{!}{\begin{tikzpicture}
		...
		\draw[->,blue, ultra thick] (1,1.732) -- (1.5, 2.59800) node[right, xshift=0.1cm] {$z_0+x$};
		\draw[->,magenta, ultra thick] (1,1.732) -- (0.139, 2.232) node[left, xshift=-0.1cm] {$z_0+iy$};
	...
	The answer to this lies in the rates of change.
	...
	To ensure $\phi$ is locally linear, we require that the rate of change in all directions respect some \textit{uniformity}.
...
\begin{ex}
	...
	\resizebox{0.4\textwidth}{!}{\begin{tikzpicture}
		...
		\draw[ultra thick, blue, ->] (0,0) -- (1.732,1);
		\draw[ultra thick, blue, ->] (0,0) -- (-1,1.732);
		\draw[ultra thick, blue, ->] (0,0) -- (-1.732,-1);
		\draw[ultra thick, blue, ->] (0,0) -- (1, -1.732);
